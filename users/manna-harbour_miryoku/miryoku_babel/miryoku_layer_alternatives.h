...
U_NP,         LT(U_BUTTON,KC_Z), ALGR_T(KC_X),      SE_C,          SE_D,               SE_V,              SE_K,                  SE_H,               KC_COMM,            SE_DOT,            SLSH_BSLS,     SE_ODIA, \
                                 LT(U_BUTTON, KC_ESC),            LT(U_NAV,KC_SPC),  LT(U_NUM_FLIP, KC_TAB),LT(U_SYM2, KC_ENT), LT(U_SYM,KC_BSPC),  LT(U_FUN, KC_DEL)
...
U_NP, RESET,             DF(U_GAMING),      DF(U_EXTRA),       DF(U_BASE),        U_NA,              U_NP,              SE_ARNG,           SE_ODIA,           SE_ADIA,           SE_QUES,                  U_NP, \
...
U_NP, KC_GRV,            SE_1,              SE_2,              SE_3,              KC_BSLS,           U_NA,              DF(U_NUM),         DF(U_NAV),         KC_ALGR,           U_NA,                     U_NP, \
...
U_NP, RESET,             U_NP,              U_NP,              DF(U_BASE),        U_NA,              U_NA,              LGUI(SE_7),        LGUI(SE_8),       LGUI(SE_9),         U_NP,                     U_NP, \
U_NP, KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              U_NU,              LGUI(SE_4),        LGUI(SE_5),       LGUI(SE_6),         U_NP,                     U_NP, \
U_NP, U_NA,              KC_ALGR,           DF(U_SYM),         U_NP,              U_NA,              U_NU,              LGUI(SE_1),        LGUI(SE_2),       LGUI(SE_3),         U_NP,                     U_NP, \
                                            U_NA,              U_NA,              U_NA,              KC_BTN2,           KC_BTN1,           KC_BTN3 

#define MIRYOKU_ALTERNATIVES_GAMING \
U_NP,       U_NP,           SE_1,           SE_2,              SE_3,              SE_4,              SE_5,              SE_Y,              SE_U,              SE_I,              SE_O,                     SE_P,                  \
U_NP,       KC_LCTL,        SE_Q,           SE_W,              SE_E,              SE_R,              SE_T,              SE_Y,              SE_U,              SE_I,              SE_O,                     SE_P,                  \
U_NP,       KC_LCTL,        LGUI_T(KC_A),   LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      SE_G,              SE_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),             LGUI_T(KC_QUOT),       \
...
U_NP,       U_NP,        U_NP,              SE_LBRC,           SE_RBRC,           SE_EXLM,           SE_ARNG,           SE_EXLM,           SE_EQL,            U_NP,              SE_QUES,                  U_NP,     \
                         U_NA,              SE_COLN,           SE_SCLN,           U_NA,              U_NA,              KC_RALT


#define MIRYOKU_ALTERNATIVES_SYM2 \
U_NP,       SE_PND,      SE_PERC,           SE_LABK,           SE_RABK,           SE_GRV,            U_NP,              U_NP,              U_NP,              U_NP,              U_NP,                     U_NP,     \
U_NP,       SE_DLR,      SE_HASH,           SE_UNDS,           SE_MINS,           SE_ACUT,           U_NP,              U_NP,              U_NP,              U_NP,              U_NP,                     U_NP,     \
U_NP,       SE_EURO,     U_NP,              SE_TILD,           SE_PLUS,           SE_CIRC,           U_NP,              U_NP,              U_NP ,             U_NP,              U_NP,                     U_NP,     \
